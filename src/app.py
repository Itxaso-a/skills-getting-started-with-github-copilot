...
activities = {
    ...
    "Tennis Club": {
        "description": "Learn and practice tennis on the school courts",
        "schedule": "Tuesdays and Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 12,
        "participants": ["alex@mergington.edu"]
    },
    "Drama Club": {
        "description": "Perform in plays and theatrical productions throughout the year",
    ...
    "Math Competition Team": {
        "description": "Prepare for regional and state math competitions",
